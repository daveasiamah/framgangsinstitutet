...
export const homeData: HomeData = {
  ...
  videoDataSubtitle:
    "Dominic började med dropshipping år 2017 och har sedan dess lyckats omsätta över 100 miljoner kronor.",
  videoDataSubtitleTwo:
    "Hans framgång beror på hårt arbete och smarta affärsbeslut.",
  ...
  expertiseData: [
    ...
    },
    {
      ...
      titleBlack: "Annonsering",
      titleBlue: "Tillväxt",
      subtitle:
        "Vi formar e-handelsbranschen genom grundläggande forskning om digital marknadsföring. Strategier som är både smidiga och effektiva.",
      lists: [
        {
          id: 1,
    ...
    },
    {
      ...
      titleBlue: "Framgång",
      subtitle:
        "Utöka ditt varumärke med djupgående kunskap. Få obegränsad tillgång till vår community och träffa andra likasinnade entreprenörer.",
      lists: [
        {
          id: 1,
          name: "Uppfyllelse",
  ...
  startSellingList: [
    {
      id: 1,
      list: "Innovativ E-handelsplattform",
    },
    {
      id: 2,
      list: "Enastående Strategier",
    },
    {
      id: 3,
      list: "Tillökning av Kapital",
    },
  ],
  ...
  reasonSubtitle:
    "Dropshipping är populärt för dess minimala kapitalkrav, eftersom det inte kräver lagerhållning och tillåter företagare att fokusera på försäljning och marknadsföring utan att behöva hantera logistiken för produktleverans.",
  reasonButton: "Gå med gratis",

  freeCourseTitle: "Gratis kurs: Kom igång med Dropshipping 2024",
  freeCourseSubtitle:
    "I den här videon delar Dominic sina hemligheter och strategier för att bygga upp sitt dropshipping-imperium och visar hur du kan göra detsamma!",
  ...
  popupSubtitle:
    "Se insidan av kursen och hur du kan få din första 100 000+ SEK per månad utan tidigare erfarenhet eller startkapital.",
  popupButton: "Se Gratis Introkurs",
  popupForm: {
    firstName: "Namn",
    email: "E-post",
  ...
  popupSuccessMessage:
    "Du har nu fått ett bekräftelsemejl skickat till dig, se till att kolla om du fått mejlet och att det inte är spam. Vi ses på andra sidan! 🎉",
  ...
  benefitData: [
    {
      ...
      subtitle:
        "Vi värdesätter våra kunder högt genom att erbjuda stöd i samband med dagliga förfrågningar.",
    },
    {
      id: 2,
      imageUrl: "/icons/home/2-find-products.png",
      title: "Hitta Produkter Att Sälja",
      subtitle:
        "Skaffa kunskap och utveckla marknadsföringsstrategier för att etablera en framgångsrik nätbutik.",
    },
    {
      id: 3,
      imageUrl: "/icons/home/3-all-in-one.png",

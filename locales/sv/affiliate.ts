...
export const affiliateData: AffiliateData = {
  ...
  guideData: {
    ...
    firstSubtitle:
      "När din ansökan har godkänts får du tillgång till reklamtillgångar och programvara för effektspårning.",
    firstLink: "Registrera konto här",
    ...
    fourthSubtitle:
      "Då du är inne på annonsörens programsida kan du ansöka till annonsören med din kanal. Du måste ha registrerat kanalen där du vill lägga upp annonser (punkt 2) för att kunna ansöka till annonsören. Välj den kanal där du vill marknadsföra annonsören och ansök genom att klicka på knappen &quot;Ansök&quot;. I de flesta fall blir du godkänd direkt till annonsören, i vissa fall godkännerannonsören din kanal i efterhand. Blir du godkänd direkt kan du omgående hämta annonser eller textlänkar.",

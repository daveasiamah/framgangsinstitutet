...
export const homeData: HomeData = {
  ...
  startSellingBlackTittle: "Start Selling In A",
  startSellingBlueTittle: "Fast Growing Industry",
  startSellingSubtitle:
    "Are you looking for a way to start your own e-commerce business without the hassle of holding inventory or managing fulfillment? Dropshipping may be the perfect solution for you. Use Checkified`s tools to simplify your e-commerce journey while increasing your chances of success.",
  startSellingList: [
    {
      id: 1,
      list: "Innovative Platform"
    },
    {
      id: 2,
      list: "Outstanding Strategies"
    },
    {
      id: 3,
      list: "Increase Capital"
    }
  ],
  startSellingButton: "Start Free Trial",
  ...
  testimonyBlackTitle: "What our",
  testimonyBlueTitle: "Students Say",
  testimonyData: [
    {
      id: 1,
  ...
  contactBlackTitle: "Get",
  contactBlueTitle: "Started",
  contactSubtitle:

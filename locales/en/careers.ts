...
export const careersData: CareersData = {
  ...
  embraceBlueTitle: "Make an Impact.",
  embraceSubtitleOne:
    "We strive to ensure universal access to superior education by offering a vast array of courses, specializations, and degrees from renowned universities and institutions worldwide through our online platform.",
  embraceSubtitleTwo:
    "Our objective is to equip individuals with essential knowledge and skills that can enhance their personal and professional growth, empowering them to achieve their utmost potential and make meaningful contributions to society.",

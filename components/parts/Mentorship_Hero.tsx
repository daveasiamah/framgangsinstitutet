        ...
        <div className="mx-auto w-full max-w-4xl flex flex-col items-center h-auto">
            ...
            <div className="relative w-full max-w-4xl mx-auto mt-6 md:mt-10 px-0">
                <div className="w-full">
                    ...
                    {/* Main Heading */}
                    <h1 className="relative w-full max-w-[320px] sm:max-w-[480px] md:max-w-[600px] lg:max-w-[749px] font-jakarta font-extrabold text-black text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center mb-4 sm:mb-6 lg:mb-4 mx-auto px-4 sm:px-6 lg:px-0 leading-tight sm:leading-snug lg:leading-normal ">
                        Snabbspår till onlineinkomst med bara din telefon &amp;
                        AI
                    </h1>

                    {/* Description */}
                    <p className="w-full font-inter  font-medium text-black text-base sm:text-lg text-center tracking-[0] leading-relaxed sm:leading-[25px] mb-4 max-w-[864px] mx-auto">

...
const MentorshipButton = ({
    ...
    const variantClasses = {
        primary:
            "bg-[#225AEA] text-white hover:bg-[#1e52d1] active:bg-[#1a47b8]",
        secondary:
    ...
    const baseClasses =
        "font-semibold text-center tracking-[0] leading-none whitespace-nowrap rounded-[7px] shadow-inner transition-all duration-200 ease-in-out transform  mx-auto flex items-center justify-center";

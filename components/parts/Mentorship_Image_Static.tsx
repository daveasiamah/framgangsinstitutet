...
const MentorshipStaticImage = () => {
    return (
        <div className="w-full max-w-[1258px] mx-auto px-4 mt-10 mb-10">
            <div className="relative w-full max-w-[1170px] mx-auto h-[314px] bg-[url(/images/mentorship/next-success.svg)] bg-[100%_100%] rounded-3xl flex flex-col items-center justify-center text-center px-6 py-8">
                {/* Icon placeholder */}

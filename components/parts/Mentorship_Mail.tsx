...
const MentorshipMailer = () => {
  return (
    <div className="relative w-full max-w-[689px] px-4 sm:px-6 lg:px-8 mb-9 mt-10 mx-auto font-inter">
          ...
          <div className="pt-8 sm:pt-10 lg:pt-12 px-4 sm:px-6 lg:px-10 text-sm sm:text-base leading-normal font-inter">
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3 sm:space-y-4 text-[#434c69] font-inter">
                ...
                <p>
                  Men först, låt mig ge dig en liten bakgrundshistoria av vem
                  egentligen är. För bara några år sedan arbetade jag på
                  Postnord...
                </p>
                ...
                <p>
                  ...
                  förmögenhet på att "testa" annonser...
                </p>
                ...
                <p>
                  Men när jag snabbspolar fram ett par år knäckte jag koden...
                  (Jag gick från 3120 SEK till över 1,2 miljoner kronor på mitt
                ...
                <div className="space-y-1 sm:space-y-2">
                  <p>Jag har pensionerat båda mina föräldrar...</p>
                  <p>Jag har rest till 50+ länder (i klass)...</p>
                  <p>
                    Jag har genererat över 120 miljoner kronor i försäljning...
                  </p>
                  <p>
                    Jag har flera tillgångar som genererar mig pengar i
                    sömnen...
                  </p>
                  <p>Jag har byggt ett av de bästa mentorskapen online...</p>
                </div>
                ...
                <p>
                  Jag säger det för att jag, till skillnad från 99,99% av gurus,
                  har varit i dina skor.
                </p>

                <div className="space-y-1 sm:space-y-2">
                  <p>Jag hade inget miljonärsnätverk.</p>
                  <p>Jag hade inga pengar till kurser.</p>
                  <p>Jag hade ingen mentor som höll min hand.</p>
                </div>

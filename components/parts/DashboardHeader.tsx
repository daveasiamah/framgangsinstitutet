        ...
        <div className="flex items-center justify-start gap-2">
          <Link className="" href="/dashboard">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="font-bold text-1xl">framgångsinstitutet</p>
            </div>
          </Link>
          ...
          <ul className="flex flex-col lg:flex-row gap-2 lg:gap-8 h-full">
              ...
              {openNotificationMenu && (
                <div className="notification-menu">
                  ...
                  >
                    ...
                    <div
                      id="scroll"
                      className="py-2 h-[14vw] overflow-y-scroll overflow-x-hidden"
                    >
                      {content && content.length > 0 ? (
            ...
            <li>
              ...
              <div
                ...
                } lg:transform lg:translate-x-1/4 lg:left-3/4 shadow-lg lg:p-7 z-10 flex flex-col lg:flex-row lg:h-auto rounded-[28px] gap-6 bg-base-100 overflow-auto transition-all duration-200 ease-in-out ${
                  openMenu
              ...
              >
                <div className="">
                  ...
                  <div className="profile-details relative -mt-8">
                    ...
                    <h2 className="font-semibold text-base mt-4 capitalize">
                      {firstName == "null" ? "" : firstName}{" "}
                      {lastName == "null" ? "" : lastName}
                    </h2>
                  </div>

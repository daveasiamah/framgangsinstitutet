  ...
  return (
    <section className="bg-white px-4 mb-[20px]">
      <div className="max-w-7xl mx-auto">
        {/* Main Title */}
        <h2 className="text-[#151E3A] text-[20px] mb-6 leading-[24px] sm:text-[32px] sm:leading-[36px] md:text-[40px] md:leading-[44px] font-bold font-jakarta text-center">
        ...
        <div className="bg-[#F3F6FE] rounded-[20px] p-6 sm:p-8 md:p-12 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-start">
            ...
            <div className="order-2 lg:order-1">
              <h3 className="text-[#151E3A] text-[18px] sm:text-[22px] md:text-[40px] font-bold font-geist mb-4 sm:mb-6 leading-[16px] sm:leading-[19px] md:leading-[35px]">

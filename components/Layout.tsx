    ...
    <>
      ...
      >
        ...
        <button
          ...
          className={`fixed bottom-6 right-4 z-40 inline-flex items-center gap-2 rounded-lg bg-[#225AEA] px-4 py-3 font-jakarta text-[11px] font-bold uppercase tracking-[0.05em] text-white transition-all duration-300 hover:bg-[#1B49C2] sm:bottom-8 sm:right-6 ${
            showBackToTop

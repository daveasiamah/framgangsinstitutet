          ...
          <article className="w-full md:w-[396px] md:h-[424px] rounded-t-[18px] overflow-hidden">
            ...
            <div className="flex flex-col h-[calc(100%-171px)] bg-[#F8F8F8] p-4">
              ...
              <p className="font-inter font-medium text-[#1E1E1E] text-[18px] md:text-[14px] leading-[1.35] md:leading-[1.4]">
                En kurs för dig som vill öka din förståelse för hur handel med
                aktier, andra värdepapper och finansiella instrument behandlas.
              </p>

              <Link
                href="/utbildningar"
                className="inline-flex items-center gap-2 mt-[40px] font-jakarta font-bold text-[#1E1E1E] text-[18px] md:text-[14px] tracking-[0.02em] uppercase"
              >
                LÄS MER
                <span
                  aria-hidden="true"

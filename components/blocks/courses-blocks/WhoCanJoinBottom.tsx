...
export const WhoCanJoinBottomSection: React.FC = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 px-4 md:px-8 py-10">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h4 className="font-jakarta font-extrabold text-[1.2rem] md:text-[1.3rem] text-[#151e3a] mb-4">
          100% på distans
        </h4>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h4 className="font-jakarta font-extrabold text-[1.2rem] md:text-[1.2rem] text-[#151e3a] mb-4">

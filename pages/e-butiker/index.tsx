...
export default function Pricing({}: Props) {
    ...
    return (
        <Layout headTitle={t.pricingData.metaData.title} isFullWidth>
            ...
            {/*    <div*/}
            {/*        className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-28 md:gap-16 md:gap-y-28 lg:gap-16 mt-36">*/}
            ...
            {/*                  <ScrollReveal*/}
            {/*                      className="relative w-full overflow-hidden z-[-1] bg-base-200 rounded-2xl p-8 pt-14">*/}
            {/*                    {data.isPopular && (*/}
            {/*                        <div*/}
            {/*                            className="bg-primary absolute text-white px-4 py-1 top-[23px] right-[-68px] text-center rotate-45 w-[200px]">*/}
            ...
            {/*  <div*/}
            {/*      className="our-culture-container flex items-center bg-primary rounded-[2rem] py-12 2xl:py-24 text-white relative mb-16 isolate xl:h-[500px] 2xl:h-auto">*/}
            {/*    <ScrollReveal*/}
            {/*        className="w-full lg:w-[55%] bg-white/10 p-8 lg:p-12 rounded-tr-3xl rounded-br-3xl backdrop-blur-xl mt-28 md:mt-48 lg:mt-0">*/}
            ...
            {/*  <div*/}
            {/*      className="container mx-auto mt-8 lg:mt-16 bg-base-200 pt-20 mb-10 lg:pb-24 lg:pt-32 px-10 lg:px-[20rem] rounded-[3rem] relative">*/}
            {/*    <Swiper*/}
            {/*        effect={"cards"}*/}
            {/*        grabCursor={true}*/}
            {/*        loop={true}*/}

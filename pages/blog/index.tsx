...
const BlurCircle = dynamic(() => import('@/components/graphic/BlurCircle'), { ssr: false });
const LineGraphic = dynamic(() => import('@/components/graphic/LineGraphic'), { ssr: false });
const ShieldBadge = dynamic(() => import('@/components/graphic/ShieldBadge'), { ssr: false });
const UserBadge = dynamic(() => import('@/components/graphic/UserBadge'), { ssr: false });
const CacingOne = dynamic(() => import('@/components/graphic/CacingOne'), { ssr: false });
const FadeLogo = dynamic(() => import('@/components/graphic/FadeLogo'), { ssr: false });
const ScrollReveal = dynamic(() => import('@/components/transition/ScrollReveal'), { ssr: false });

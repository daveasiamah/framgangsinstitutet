  ...
  const faqData = [
    {
      ...
      answer:
        "Dropshipping innebär kostnader som Shopify och marknadsföring. Hur mycket du investerar avgör hur snabbt du kan testa och skala produkter. Vi rekommenderar minst 3 000 SEK per månad, men mer investering ger snabbare resultat.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "Det krävs ingen stor tidsinsats för att starta med dropshipping. Vi rekommenderar att du avsätter runt 30 minuter om dagen för att arbeta med din butik och lära dig nya strategier. För de som vill satsa seriöst kan det krävas mer tid för produktforskning och att skala upp marknadsföringen.",
    },
    {
      id: 4,
      question: "Hur lång tid tar det att göra sin första försäljning?",
      answer:
        "Enligt vår senaste community-undersökning tar det i genomsnitt 22 dagar för deltagare att göra sin första försäljning efter att ha börjat programmet. Resultatet kan dock variera beroende på hur mycket tid och energi du investerar.",
    },
    {
      id: 5,
      ...
      <Layout headTitle={t.homeData.metaData.title}>
          ...
          <div className="w-full text-center mb-6 lg:mb-0">
            ...
            <div className="flex justify-center items-center gap-1 mt-3">
              <Image
                ...
                height={48}
              />
              <span className=" text-[6px] lg:text-sm text-gray-500 font-inter">
                Gå med 750+ aktiva studenter
              </span>
            </div>
              ...
              <div className="flex flex-col items-center justify-center gap-1 bg-[#EDF5FED9] pt-2 pl-2 pr-2 pb-2 rounded-[10px] relative  max-w-[706px] mx-auto">
                <div className="lg:flex flex top-0 w-full items-center justify-center gap-1 mb-[-5px] bg-primary text-white">
                  <Image
                    ...
                    height={16}
                  />
                  <h3 className="text-[6px] lg:text-sm">
        ...
        <section className="md:p-8 lg:py-14 lg:px-16 text-center  lg:my-18 rounded-2xl">
          <div className="flex justify-between items-center">
            ...
            <span className="font-[600] tex-[14px] md:text-[20px] md:w-[20%] w-full md:ml-4 md:mr-4 text-[#434C69 font-jakarta">
              KUNSKAP INOM
            </span>
            <hr className="w-[40%] border-t-1 border-[#555A7733]" />
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center">
            ...
            <div className="w-full lg:w-1/2 lg:mr-20 md:mb-8 lg:mb-0 order-0 lg:order-0">
              <div className="hidden lg:block">
                ...
                <h1 className="text-[20px] lg:text-[24px] font-[700] font-jakarta">
                  dropshipping företag
                </h1>
              </div>

              <h1 className="lg:hidden md:hidden text-[20px] leading-[22px] font-jakarta font-[700]">
                <span className="text-[#2E56F5]">Steg-för-steg guide</span> till
                att <br /> bygga dropshipping företag
              </h1>

              <p className="mt-4 text-[#434C69] text-[12px]  lg:text-[14px] leading-[22px] font-[500] font-inter">
                Lär dig hur du bygger, skalar och drar nytta av
                e-handelsbutiker. Från din första miljon i intäkter till en
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="w-full lg:w-1/2  lg:mb-20 text-left lg:text-left">
              ...
              <p className="text-[20px] leading-[26px] font-[700]  lg:ml-2 lg:hidden md:hidden text-left font-jakarta">
                Är du redo för en{" "}
                <span className="text-[#225AEA]">förändring?</span>
              </p>

              <p className=" text-[#434C69] text-[14px] leading-[22px] text-left font-[500px] font-inter mt-4">
                Se om dropshipping kan vara din väg till frihet. Kolla igenom
                våran gratis kurs för att se hur dropshipping gjorde Dominic
                till en e-handelsmiljonär och förändra sitt liv.
              </p>
              ...
              <ul className="mt-4">
                <li className="flex items-center text-[#434C69] text-[14px] leading-[32px] font-[500px] font-inter mt-4">
                  ...
                  >
                    <path
                      d="M1 6.89474L6.05263 11.9474L17 1"
                      stroke="#1BC057"
                      strokeWidth="2"
                      strokeLinecap="round"
        ...
        <section className="relative text-center mb-16 mt-8 lg:mb-20 md:mt-20">
          <ScrollReveal>
            ...
            <p className="lg:block text-left text-[14px] lg:text-[16px] text-[#434C69] leading-[20px] font-normal mb-5">
              Utforska våra tjänster för att ge dig superkraft i din
              dropshipping resa
            </p>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="p-3 pt-5 pb-5 lg:p-5 rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left">
                <h1 className="font-[700] text-[16px]  lg:text-[22px] text-[#151E3A] leading-[28px] mt-2">
                  Dropshipping Gratis Kurs
                </h1>
                <p className="font-[500] font-inter text-[13px] text-[#434C69] leading-[22px]">
                  I kursen kommer du lära dig om dropshipping e-handel och
                  marknadsföring. Gå med idag gratis👇
                </p>
              </div>
              <button
                onClick={() =>
            ...
            <div className="p-3 pt-5 pb-5 lg:p-5 rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left">
                <h1 className="font-[700] text-[16px]  lg:text-[22px] text-[#151E3A] leading-[28px] mt-2">
                  Dropshipping Sverige Kurs
                </h1>
                <p className="font-[500] font-inter text-[13px] text-[#434C69] leading-[22px]">
                  Gå från 0-100k/mån med dropshipping. Över 45+ avsnitt. Tryck
                  på knappen nedan för att gå med👇
                </p>
              </div>
              <button
                onClick={() =>
                ...
                <ul>
                  ...
                  <li className="mt-4 text-[11px] lg:text-[12px]">
                    <div className="flex justify-between items-center">
                      ...
                      <small className="lg:text-[11px] text-[9px]">
                        Marknadsföring, SEO, Webbutveckling, & AI
                      </small>
                    </div>
                  </li>
                  <li className="mt-4 text-[11px] lg:text-[12px]">
            ...
            <div className="p-3 pt-5 pb-5 lg:p-5 rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left">
                <h1 className="font-[700] text-[16px]  lg:text-[22px] text-[#151E3A] leading-[28px] mt-2">
                  Dropshipping Färdiga Annonser
                </h1>
                <p className="font-[500] font-inter text-[13px] text-[#434C69] leading-[22px]">
                  Köp videoannonser för att marknadsföra innehåll för endast 399
                  SEK här👇
                </p>
              </div>
              <button
                ...
                <ul>
                  ...
                  <li className="mt-4 text-[10px] lg:text-[12px]">
                    <div className="flex justify-between items-center">
                      ...
                      <small className="lg:text-[10px] text-[9px]">
                        {" "}
            ...
            <div className="p-3 pt-5 pb-5 lg:p-5 rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left">
                ...
                <p className="font-[500] font-inter text-[13px] text-[#434C69] leading-[22px]">
                  Köp 1-on-1 mentorskap med privat vägledning och hemliga
                  strategier inom dropshipping & ehandel här👇
                </p>
              </div>
              <button
                onClick={() =>
            ...
            <div className="p-3 pt-5 pb-5 lg:p-5 rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left">
                <h1 className="font-[700] text-[16px]  lg:text-[22px] text-[#151E3A] leading-[28px] mt-2">
                  Dropshipping Färdig Butik
                </h1>
                <p className="font-[500] font-inter text-[13px] text-[#434C69] leading-[22px]">
                  Köp din e-butik med 20 vinnande produkter, 5 video annonser,
                  logotyp, leverantör, och e-bok här👇
                </p>
              </div>
              <button
                onClick={() =>
                ...
                <ul>
                  ...
                  <li className="mt-4 text-[11px] lg:text-[12px]">
                    <div className="flex justify-between items-center">
                      ...
                      <small className="lg:text-[11px] text-[9px]">
                        20 produkter, video annonser & logotyp
                      </small>
                    </div>
                  </li>
                  <li className="mt-4 text-[11px] lg:text-[12px]">
        ...
        <section className="relative flex flex-col justify-center md:mb-16 lg:mb-20">
          <div className="lg:mt-8 py-8 bg-base-200 rounded-2xl  justify-center">
            <div>
              <h1 className="lg:w-50 text-[18px] leading-[18px] text-center lg:text-[32px] lg:leading-[40px] mb-4 font-bold">
                Uppdelning av Dominics resultat <br /> och finansiella poster
              </h1>
            </div>
        ...
        <section className="relative text-center lg:mb-[16px] lg:[mb-20px] lg:mt-20">
          <ScrollReveal>
            ...
            <p className="lg:block text-left text-[14px] lg:text-[16px] text-[#434C69] leading-[20px] font-normal mb-5">
              Byggd av e-handlare för e-handlare med uppdraget att hjälpa
              entreprenörer att starta och växa framgångsrika företag.
            </p>
          </ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="rounded-[2rem] border border-1 border-[#BBBBBF] ">
              ...
              <div className="text-left pl-4 pb-4">
                <h1 className="font-[700] font-jakarta text-[16px] lg:text-[22px] text-[#151E3A] leading-[28px] mt-2">
                  En sälj, pengarna tillbaka
                </h1>
                <p className="font-[500] font-inter text-[12px] lg:text-[13px] text-[#434C69] leading-[22px]">
                  Ungefär en sälj är allt du behöver för att täcka kostnaden för
                  ett abonnemang hos oss. Å andra sidan skulle en vinnare göra
                  underverk. Du är en dropshipping produkt ifrån framgång
                </p>
              </div>
            </div>
            <div className="rounded-[2rem] border border-1 border-[#BBBBBF]">
              ...
              <div className="text-left  pl-4 pb-4">
                ...
                <p className="font-[500] font-inter text-[12px] lg:text-[13px] text-[#434C69] leading-[22px]">
                  Ge dig själv en utmärkt framgång med stora mängder
                  strategiinsikter som ingår i Checkified Dropshipping Sverige.
                  Du lär dig allt om e-handel.
                </p>
              </div>
            </div>
            <div className="rounded-[2rem] border border-1 border-[#BBBBBF] ">
              ...
              <div className="text-left pl-4 pb-4">
                ...
                <p className="font-[500] font-inter text-[12px] lg:text-[13px] text-[#434C69] leading-[22px]">
                  Håll dig informerad om dropshipping, e-handel, marknadsföring
                  eller potentiella möjligheter som kan hjälpa ditt företag.
                  Allt för att spara tid och pengar.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative lg:pt-48 pt-20  items-center justify-center testimonial-slider-container">
            <div className="absolute" style={{}}>
              <div className="items-center left-0 gap-2 justify-around testimonial-slider">
                <Marquee
                  style={{ width: "1300px", overflow: "visible" }}
                  speed={30}
                >

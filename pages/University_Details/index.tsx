            ...
            <div className="grid grid-cols-2 gap-12">
              <div className="relative  h-[26vw] rounded-[3rem] overflow-hidden">
                <img
                  ...
                  alt="card"
                />
                <div className="absolute  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-[4vw] h-[4vw] flex justify-center items-center rounded-full opacity-[70%]">
                  <img src="/play.png" className="w-[1.25vw]" />
                </div>
              </div>
              <div className="flex flex-col justify-center items-start">
                <Title
                  blackText="framgångsinstitutet"
          ...
          <div className="grid grid-cols-11 gap-12 ">
            <div className="p-4 lg:p-6 bg-base-200 rounded-[1rem]  col-span-3 h-fit">
              ...
              <div className="flex justify-between">
                <p className="mb-3 text-subtitle">Video</p>
                <p className="mb-3 text-subtitle">18</p>
              </div>
              <div className="flex justify-between">
                <p className="mb-6 text-subtitle">Length</p>
                <p className="mb-6 text-subtitle">2hr 34min</p>
              </div>
              <div>
                <Link href="/signup" className="mt btn btn-primary w-full">
                  Watch Course
                </Link>
              </div>
            </div>
              ...
              <section className="relative ">
                <ScrollReveal>
                  <Title
                    blackText="Course"
                    blueText="Outline"
                    className="mb-2_cmargin"
                  />
                  <p className="mb-6 text-subtitle">Introduction</p>
                </ScrollReveal>
                <div className="grid grid-cols-1 gap-6 mb-6">
                  <ScrollReveal className="flex justify-between items-center bg-base-200 py-4 px-8 rounded-2xl">
